-- seed.sql
-- Populates the products table with all PickNPack fruits, vegetables, and greens.
...
(14, 'Custard Apple', 'fruit', 'https://images.unsplash.com/photo-1627843563094-cf19d3f1d0e9?w=200&h=200&fit=crop&auto=format', 0),
...
(29, 'Cabbage',                  'vegetable', 'https://images.unsplash.com/photo-1592548868664-f8b4e4b1cfb7?w=200&h=200&fit=crop&auto=format', 0),
...
(32, 'Capsicum',                 'vegetable', 'https://images.unsplash.com/photo-1592548868664-f8b4e4b1cfb7?w=200&h=200&fit=crop&auto=format', 0),
...
(50, 'White Pumpkin',            'vegetable', 'https://images.unsplash.com/photo-1695555801863-8b1a577d5124?w=200&h=200&fit=crop&auto=format', 0),
...
(53, 'Small Onion',              'vegetable', 'https://images.pexels.com/photos/12353768/pexels-photo-12353768.jpeg?w=200&h=200&fit=crop&auto=compress', 0),
...
-- ============================================================
INSERT INTO products (id, name, category, image, votes) VALUES
(62, 'Spinach (Pasalai Keerai)',  'green', 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=200&h=200&fit=crop&auto=format', 0),
(63, 'Arai Keerai',               'green', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop&auto=format', 0),
(64, 'Siru Keerai',               'green', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop&auto=format', 0),
(65, 'Mulai Keerai',              'green', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop&auto=format', 0),
(66, 'Ponnanganni Keerai',        'green', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop&auto=format', 0),
(67, 'Agathi Keerai',             'green', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop&auto=format', 0),
(68, 'Murungai Keerai',           'green', 'https://images.unsplash.com/photo-1595118612285-a12a837ed80f?w=200&h=200&fit=crop&auto=format', 0),
(69, 'Palak',                     'green', 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=200&h=200&fit=crop&auto=format', 0),
(70, 'Methi (Fenugreek Leaves)',  'green', 'https://images.unsplash.com/photo-1611690960756-46f0d11e72ea?w=200&h=200&fit=crop&auto=format', 0),
...
(74, 'Dill Leaves',               'green', 'https://images.unsplash.com/photo-1612197527762-8cfb55e4b9a7?w=200&h=200&fit=crop&auto=format', 0)
